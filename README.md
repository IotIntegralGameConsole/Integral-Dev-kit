...
We may follow Dual Licenses Over(Bsd 3 Clause, Apache License Version etc) except Main Custom CPU/GPU(FPGA) Module(undecided) based in x86, MIPS, ARM, PowerPC etc, ODD(CD, DVD, Blu-ray etc)(undecided)with MCU Board like Raspberry-Pi, Samsung Artik etc
